...
const hook = ({gl}) => {
    ...
    const isCompileVertexShader = gl.getShaderParameter(vertextShader, gl.COMPILE_STATUS)
    ...
    const isCompileFragmentShader = gl.getShaderParameter(frageShader, gl.COMPILE_STATUS)
