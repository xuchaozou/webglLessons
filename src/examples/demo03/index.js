...
const hook = ({gl}) => {
    ...
    const isVertextSuccess = gl.getShaderParameter(vertextShader, gl.COMPILE_STATUS)
    if(!isVertextSuccess) {
    ...
    const isSuccessFragment = gl.getShaderParameter(fragmentShader, gl.COMPILE_STATUS)
